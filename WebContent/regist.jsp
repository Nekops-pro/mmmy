...
<div id="rightSide">
    ...
    <div class="wrapper">
        ...
        <!-- Validation form -->
        <form id="validate" class="form" method="post" action="${pageContext.request.contextPath}/contrl">
        	<fieldset>
                <div class="widget">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight"><input type="password" class="validate[required]" name="password1" id="userPsw" /></div><div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <label>userEmail:<span class="req">*</span></label>
                        <div class="formRight"><input type="text" class="validate[required,equals[password]]" name="userEmail" id="password2" /></div><div class="clear"></div>
                    </div>
